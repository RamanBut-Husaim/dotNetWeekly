...
1. [Decryption with Azure Key Vault](https://odetocode.com/blogs/scott/archive/2018/03/08/decryption-with-azure-key-vault.aspx)
...
1. [Debugging Distributed Systems](https://www.infoq.com/articles/microservices-debugging-squash)
1. [Visual Studio 15.6 is out the door](https://docs.microsoft.com/en-us/visualstudio/releasenotes/vs2017-relnotes)
...
1. [zheap - a storage engine to provide better control over bloat](http://amitkapila16.blogspot.com.es/2018/03/zheap-storage-engine-to-provide-better.html)
1. [Containers - What Are They Good For? Build Environments?](https://jimmybogard.com/containers-what-are-they-good-for-build/)
...
1. [Really interesting discussion on the pros and cons of 'reified' and 'erased' generics (e.g CLR v JVM)](https://news.ycombinator.com/item?id=16525244)
...
1. [System.IO in .NET Core 2.1 sneak peek](https://blogs.msdn.microsoft.com/jeremykuhne/2018/03/08/system-io-in-net-core-2-1-sneek-peek/)

## Other

1. [The Agile Fluency Model](https://martinfowler.com/articles/agileFluency.html)
1. [Clang is now used to build Chrome for Windows](http://blog.llvm.org/2018/03/clang-is-now-used-to-build-chrome-for.html)
