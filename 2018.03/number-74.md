...
1. [MS Orleans RC2](https://github.com/dotnet/orleans/releases/tag/v2.0.0-rc2)
1. [More love from BenchmarkDotNet to CoreFX](https://github.com/dotnet/corefx/pull/27164)
1. [Xamarin docs open-sourced](https://github.com/MicrosoftDocs/xamarin-docs)
1. [GDPR Tools in SSMS](http://irisclasson.com/2018/03/13/gdpr-tools-in-ssms/)
1. [Ooui.Wasm - .NET in the browser](http://praeclarum.org/post/171899388348/oouiwasm-net-in-the-browser)
1. [Docker for Windows 18.02 now supports Linux and Windows containers running side-by-side via LCOW, using a single Docker daemon](https://blog.docker.com/2018/02/docker-for-windows-18-02-with-windows-10-fall-creators-update/)
...
1. [How to use Span<T> and Memory<T>](https://medium.com/@antao.almada/how-to-use-span-t-and-memory-t-c0b126aae652)
1. [ILEmit backend for DependencyInjeciton](https://github.com/aspnet/DependencyInjection/pull/630)
1. [JIT produces suboptimal code (unnecessary call) when using recent ReadOnlySpan compiler optimizations](https://github.com/dotnet/coreclr/issues/16944)
1. [Announcement - Driving towards zero 2.1 bugs by March 31 (ZBB)](https://github.com/dotnet/corefx/issues/28114)
1. [Remove some low-hanging fruit allocations from SocketsHttpHandler connections](https://github.com/dotnet/corefx/pull/28134)
1. [There is now a daily community build of an arm32 .NET Core 2.1 SDK](https://dotnetcli.blob.core.windows.net/dotnet/Sdk/master/dotnet-sdk-latest-linux-arm.tar.gz)

## Other

1. [In praise of SWARMing](https://dannorth.net/2018/01/26/in-praise-of-swarming/)
1. [How to write a successful conference proposal](https://dave.cheney.net/2017/02/12/how-to-write-a-successful-conference-proposal)
1. [Rust's 2018 roadmap](https://blog.rust-lang.org/2018/03/12/roadmap.html)
1. [Building Windows - 4 million commits, 10 million work items](https://arstechnica.com/gadgets/2018/03/building-windows-4-million-commits-10-million-work-items/)
1. [SO Developer Survey Results 2018](https://insights.stackoverflow.com/survey/2018)
