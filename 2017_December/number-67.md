...
1. [Hybridizer - High-Performance C# on GPUs](https://devblogs.nvidia.com/parallelforall/hybridizer-csharp/)
1. [LiteDB - A .NET NoSQL Document Store in a single data file](https://github.com/mbdavid/LiteDB#litedb---a-net-nosql-document-store-in-a-single-data-file)
1. [MS Orleans v2.0.0-beta3](https://github.com/dotnet/orleans/releases/tag/v2.0.0-beta3)
1. [Building ASP.NET Core apps using Cake in Docker](https://andrewlock.net/building-asp-net-core-apps-using-cake-in-docker/)

## Architecture & Databases

1. [SRP is a Hoax](http://www.yegor256.com/2017/12/19/srp-is-hoax.html)
1. [Serializing your domain model](https://fsharpforfunandprofit.com/posts/serializating-your-domain-model/)
1. [Handling Billions of Edges in a Graph Database](https://www.infoq.com/presentations/graph-database-scalability)
...
1. [Build a DeepLearning algorithm from scratch in F# 02 – Planar data classification with one hidden layer](http://mathieuclerici.com/2017/12/17/build-a-deeplearning-algorithm-from-scratch-in-f-02-planar-data-classification-with-one-hidden-layer/)
...
1. [CSS support in Xamarin.Forms](https://github.com/xamarin/Xamarin.Forms/pull/1207)
1. [Rust in 2017 - what we achieved](https://blog.rust-lang.org/2017/12/21/rust-in-2017.html)
