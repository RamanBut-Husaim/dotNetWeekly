...
1. [Adding Serilog to the ASP.NET Core Generic Host](https://andrewlock.net/adding-serilog-to-the-asp-net-core-generic-host/)
1. [The Developer’s Guide to Microsoft Azure eBook - August update is now available](https://azure.microsoft.com/en-us/blog/the-developer-s-guide-to-microsoft-azure-ebook-august-update-is-now-available/)
...
1. [Announcing ML.NET 0.4](https://blogs.msdn.microsoft.com/dotnet/2018/08/07/announcing-ml-net-0-4/)
1. [VSCode - New home for the Debug Adapter Protocol](https://code.visualstudio.com/blogs/2018/08/07/debug-adapter-protocol-website)
1. [Fixing Visual Studio Intellisense Errors](https://weblog.west-wind.com/posts/2018/Aug/07/Fixing-Visual-Studio-Intellisense-Errors)
1. [Are your Windows Forms and WPF applications ready for .NET Core 3.0?](https://blogs.msdn.microsoft.com/dotnet/2018/08/08/are-your-windows-forms-and-wpf-applications-ready-for-net-core-3-0/)
1. [Code completion improvements in Rider 2018.2 EAP](https://blog.jetbrains.com/dotnet/2018/08/09/code-completion-improvements-rider-2018-2-eap/)
1. [Detours is a software package for monitoring and instrumenting API calls on Windows.](https://github.com/Microsoft/Detours)
1. [NuGet.org starts repo-signing packages](https://blog.nuget.org/20180810/Introducing-Repository-Signatures.html)
...
1. [ref structs in C# 7.2 - .NET Concept of the Week - Episode 16](https://kalapos.net/Blog/ShowPost/DotNetConceptOfTheWeek16-RefStruct)
1. [Dart 2.0 is now available](https://www.dartlang.org/dart-2)
...
1. [Support for reflection-invoking methods that take pointers by reference](https://github.com/dotnet/coreclr/issues/19307)
1. [Enable unloading of AssemblyLoadContext](https://github.com/dotnet/coreclr/pull/18476)
...
1. [Mozilla's new DNS resolution is dangerous](https://blog.ungleich.ch/en-us/cms/blog/2018/08/04/mozillas-new-dns-resolution-is-dangerous/)
1. [Linux Kernel TCP Vulnerability](https://blogs.akamai.com/2018/08/linux-kernel-tcp-vulnerability.html)
1. [GLB - GitHub's open source load balancer](https://githubengineering.com/glb-director-open-source-load-balancer/)
1. [Why Open Source Failed](https://medium.com/@johnmark/why-open-source-failed-6cae5d6a9f6)
