...
1. [Using Consul for Health Checks with ASP.NET Core](http://cecilphillip.com/using-consul-for-health-checks-with-asp-net-core/)
1. [Penny Pinching in the Cloud - Lift and Shift vs App Services - When a VM in the Cloud isn't what you want](https://www.hanselman.com/blog/PennyPinchingInTheCloudLiftAndShiftVsAppServicesWhenAVMInTheCloudIsntWhatYouWant.aspx)
...
1. [High-performance .NET by example - Filtering bot traffic](https://alexandrnikitin.github.io/blog/high-performance-dotnet-by-example/)
