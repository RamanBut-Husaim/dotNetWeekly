...
1. [Collecting Hardware Performance Counters with BenchmarkDotNet](http://adamsitnik.com/Hardware-Counters-Diagnoser/)
1. [Meet ReSharper Ultimate 2017.1!](https://blog.jetbrains.com/dotnet/2017/04/03/meet-resharper-ultimate-2017-1/)
1. [Microsoft Updates its Deep Learning Toolkit](https://blogs.technet.microsoft.com/machinelearning/2017/04/03/microsoft-updates-its-deep-learning-toolkit/)
1. [Alba 1.0 – Recipes for ASP.Net Core Integration Testing](https://jeremydmiller.com/2017/04/05/alba-1-0-recipes-for-asp-net-core-integration-testing/)
...
1. [Tracing .NET Core on Linux with USDT and BCC](http://blogs.microsoft.co.il/sasha/2017/04/02/tracing-net-core-on-linux-with-usdt-and-bcc/)
1. [No GCs for your allocations?](https://blogs.msdn.microsoft.com/maoni/2017/04/02/no-gcs-for-your-allocations/)
1. [ILLink (Mono linker) has been added to .NET Core](https://github.com/dotnet/corefx/pull/17825)
1. [Announcing the .NET Framework 4.7](https://blogs.msdn.microsoft.com/dotnet/2017/04/05/announcing-the-net-framework-4-7/)
