...
1. [BenchmarkDotNet v0.10.11 has been released - ByRef and Stack-only support, .NET Core 2.1 support](https://github.com/dotnet/BenchmarkDotNet/wiki/ChangeLog)
...
1. [NULL in SQL - Indicating the Absence of Data](http://modern-sql.com/concept/null)
1. [How Jet Built a GPU-Powered Fulfillment Engine with F# and CUDA](https://devblogs.nvidia.com/parallelforall/jet-gpu-powered-fulfillment/)
1. [Precompiled Azure Functions in F#](https://mikhail.io/2017/12/precompiled-azure-functions-in-fsharp/)

## Runtime

1. [Exploring the BBC micro:bit Software Stack](http://mattwarren.org/2017/11/28/Exploring-the-BBC-microbit-Software-Stack/)
1. [Dissecting the async methods in C#](https://blogs.msdn.microsoft.com/seteplia/2017/11/30/dissecting-the-async-methods-in-c/)
1. [Debugging .NET Core CLR afterword](https://fsou1.github.io/Net_core_debug/)
1. [Benchmarking .NET Core 2.0/2.1 applications with BenchmarkDotNet](https://github.com/dotnet/corefx/pull/25612)
1. [If you have a finalizer, watch your ctor](https://ayende.com/blog/180641/if-you-have-a-finalizer-watch-your-ctor)
