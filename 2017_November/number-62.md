...
1. [Creating a custom xUnit theory test DataAttribute to load data from JSON files](https://andrewlock.net/creating-a-custom-xunit-theory-test-dataattribute-to-load-data-from-json-files/)
...
1. [Rider 2017.2.1 is available](https://blog.jetbrains.com/dotnet/2017/11/13/rider-2017-2-1-available/)
1. [Badass Terminal - FCU WSL Edition (oh-my-zsh, powerlevel9k, tmux, and more!)](http://jessicadeen.com/tech/microsoft/badass-terminal-fcu-wsl-edition-oh-my-zsh-powerlevel9k-tmux-and-more/)
1. [On-Device Conversational Modeling with TensorFlow Lite](https://research.googleblog.com/2017/11/on-device-conversational-modeling-with.html)
1. [SQL Operations Studio](https://github.com/Microsoft/sqlopsstudio)
...
1. [Endomorphism monoid](http://blog.ploeh.dk/2017/11/13/endomorphism-monoid/)
1. [Implementing a Text Templating Language and Engine for .NET](http://xoofx.com/blog/2017/11/13/implementing-a-text-templating-language-and-engine-for-dotnet/)
1. [Introducing Nullable Reference Types in C#](https://blogs.msdn.microsoft.com/dotnet/2017/11/15/nullable-reference-types-in-csharp/)
1. [Welcome to C# 7.2 and Span](https://blogs.msdn.microsoft.com/dotnet/2017/11/15/welcome-to-c-7-2-and-span/)
1. [Rider’s F# plugin is now open source](https://blog.jetbrains.com/dotnet/2017/11/16/riders-f-plugin-now-open-source/)

## Runtime

1. [Mono's New .NET Interpreter](http://www.mono-project.com/news/2017/11/13/mono-interpreter/)
1. [.NET Framework November 2017 Security and Quality Rollup](https://blogs.msdn.microsoft.com/dotnet/2017/11/14/net-framework-november-2017-security-and-quality-rollup/)
1. [.NET Core November 2017 Update](https://blogs.msdn.microsoft.com/dotnet/2017/11/14/net-core-november-2017-update/)
1. [Debugging Stories](https://github.com/danluu/debugging-stories)
1. [Announcing the Windows Compatibility Pack for .NET Core](https://blogs.msdn.microsoft.com/dotnet/2017/11/16/announcing-the-windows-compatibility-pack-for-net-core/)

## Other

1. [Linux 4.14](https://kernelnewbies.org/Linux_4.14)
1. [MachineJustification](https://martinfowler.com/bliki/MachineJustification.html)
1. [Fearless Concurrency in Firefox Quantum](https://blog.rust-lang.org/2017/11/14/Fearless-Concurrency-In-Firefox-Quantum.html)
