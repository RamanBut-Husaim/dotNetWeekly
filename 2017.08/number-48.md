...
1. [Hello WebAssembly](http://www.mono-project.com/news/2017/08/09/hello-webassembly/)
...
1. [Akka.NET v1.3.0 Stable Release](https://github.com/akkadotnet/akka.net/releases/tag/v1.3.0)
1. [Visual Studio Code 1.5 Released](https://code.visualstudio.com/updates/v1_15)
1. [Using .NET Core 2 on Raspbian Jessie to read serial data from an Arduino](https://jeremylindsayni.wordpress.com/2017/08/07/using-net-core-2-on-raspbian-jessie-to-read-serial-data-from-an-arduino/)
1. [NuGet Fall 2017 Roadmap](https://blog.nuget.org/20170809/NuGet-Fall-2017-Roadmap.html)
...
1. [Passing data between Promise callbacks](http://2ality.com/2017/08/promise-callback-data-flow.html)
1. [ES proposal - Promise.try()](http://2ality.com/2017/08/promise-try.html)
1. [ES proposal - optional catch binding](http://2ality.com/2017/08/optional-catch-binding.html)
...
1. [.NET Standard 2.0 is final](https://github.com/dotnet/announcements/issues/24)
1. [Proposed SslStream additions for ALPN and SNI](https://github.com/dotnet/corefx/issues/23077)
1. [System.ValueTuple now supports .NET Framework 4.7](https://github.com/dotnet/announcements/issues/25)
1. [ConcurrentDictionary.Count is locking](https://ayende.com/blog/179329/public-service-announcement-concurrentdictionary-count-is-locking)
