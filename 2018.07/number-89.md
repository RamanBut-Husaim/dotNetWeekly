# .NET Weekly #89 (09.07 - 15.07)

## Cloud & Web

1. [Updating part of an ASP.NET Core MVC View which uses Forms](https://damienbod.com/2018/07/08/updating-part-of-an-asp-net-core-mvc-view-which-uses-forms/)
1. [Optimally Configuring Entity Framework Core](https://rehansaeed.com/optimally-configuring-entity-framework-core/)
...
1. [Demystifying WebSockets for Real-Time Web Communication](https://miguelgfierro.com/blog/2018/demystifying-websockets-for-real-time-web-communication/)
1. [Site Isolation for web developers](https://developers.google.com/web/updates/2018/07/site-isolation)
...
1. [Fedora CoreOS, Red Hat CoreOS, and the future of Container Linux](https://coreos.com/blog/fedora-coreos-red-hat-coreos-and-future-container-linux)
1. [Add Brotli compression provider](https://github.com/aspnet/BasicMiddleware/pull/342)
...
1. [Typing and testing problem 23](http://blog.ploeh.dk/2018/07/09/typing-and-testing-problem-23/)
1. [Refactoring at Scale with Abstract Syntax Trees](https://medium.com/zoosk-engineering/refactoring-at-scale-with-abstract-syntax-trees-a3f989ec8524)
1. [Announcing TypeScript 3.0 RC](https://blogs.msdn.microsoft.com/typescript/2018/07/12/announcing-typescript-3-0-rc/)
...
1. [System.IO.Pipelines - High performance IO in .NET](https://blogs.msdn.microsoft.com/dotnet/2018/07/09/system-io-pipelines-high-performance-io-in-net/)
1. [.NET Core July 2018 Update](https://blogs.msdn.microsoft.com/dotnet/2018/07/10/net-core-july-2018-update/)
1. [How Inlined Code Makes For Confusing Profiles](http://psy-lob-saw.blogspot.com/2018/07/how-inlined-code-confusing-profiles.html)
1. [.NET Framework 4.7.2 is available on Windows Update, WSUS and MU Catalog](https://blogs.msdn.microsoft.com/dotnet/2018/07/10/net-framework-4-7-2-is-available-on-windows-update-wsus-and-mu-catalog/)
1. [Reordered code after compilation](https://blog.adamfurmanek.pl/2018/06/16/reordered-code-after-compilation/)
1. [Presentations and Talks covering .NET Internals](http://mattwarren.org/2018/07/12/Presentations-and-Talks-covering-.NET-Internals/)
1. [Improve Int32/Int64 Parse performance for NumberStyles.Integer](https://github.com/dotnet/coreclr/pull/18897)

## Other

1. [Welcome Wagon - Classifying Comments on Stack Overflow](https://stackoverflow.blog/2018/07/10/welcome-wagon-classifying-comments-on-stack-overflow/)
1. [15 principles of good service design](https://blog.louisedowne.com/2018/06/14/15-principles-of-good-service-design/)
1. [A Distributed Systems Reading List](http://dancres.github.io/Pages/)
1. [Why Isn't Debugging Treated As A First-Class Activity?](https://robert.ocallahan.org/2018/07/why-isnt-debugging-treated-as-first.html)
