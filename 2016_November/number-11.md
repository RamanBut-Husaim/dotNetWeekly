# .NET Weekly #10 (21.11 - 27.11)

## Cloud & Web

1. [Extending Identity in IdentityServer4 to manage users in ASP.NET Core](https://damienbod.com/2016/11/18/extending-identity-in-identityserver4-to-manage-users-in-asp-net-core/)
1. [R.I.P project.json – Out with the new, in with the old](https://www.stevejgordon.co.uk/project-json-replaced-by-csproj)
1. [ASP.NET Core and the Enterprise Part 3: Middleware](http://odetocode.com/blogs/scott/archive/2016/11/22/asp-net-core-and-the-enterprise-part-3-middleware.aspx)
