...
1. [Announcing Azure Pipelines with unlimited CI/CD minutes for open source](https://azure.microsoft.com/en-us/blog/announcing-azure-pipelines-with-unlimited-ci-cd-minutes-for-open-source/)
1. [How Discord Handles Two and Half Million Concurrent Voice Users using WebRTC](https://blog.discordapp.com/how-discord-handles-two-and-half-million-concurrent-voice-users-using-webrtc-ce01c3187429)
1. [Developing APIs using Actor model in ASP.NET Core](https://samueleresca.net/2018/07/developing-apis-using-actor-model-in-asp-net/)
...
1. [libcurl gets a URL API](https://daniel.haxx.se/blog/2018/09/09/libcurl-gets-a-url-api/)
1. [Automated load balancer (HAProxy) creation on DigitalOcean](https://codinghaus.de/2018/09/09/automated-load-balancer-haproxy-creation-on-digitalocean/)
1. [Ansible Tower 3.3 Available Now](https://www.ansible.com/blog/ansible-tower-3.3-available-now)
1. [Cloud Native Infrastructure with Kubernetes and Pulumi](https://blog.pulumi.com/cloud-native-infrastructure-with-kubernetes-and-pulumi)
1. [Announcing ML.NET 0.5](https://blogs.msdn.microsoft.com/dotnet/2018/09/12/announcing-ml-net-0-5/)
1. [Git 2.19.0 released](https://lwn.net/Articles/764552/)
1. [OpenSSL 1.1.1 Is Released](https://www.openssl.org/blog/blog/2018/09/11/release111/)
1. [Open-sourcing LogDevice, a distributed data store for sequential data](https://logdevice.io/blog/2018/09/12/open-sourcing-announcement.html)
1. [Introducing the React Profiler](https://reactjs.org/blog/2018/09/10/introducing-the-react-profiler.html)
1. [Next Generation Package Management](https://blog.npmjs.org/post/178027064160/next-generation-package-management)

## Architecture & Databases

1. [GopherCon 2018 - From Prototype to Production - Lessons from Building and Scaling Reddit's Ad Serving Platform with Go](https://about.sourcegraph.com/go/gophercon-2018-from-prototype-to-production-lessons-from-building-and/)
1. [Event Based Application - Back Pressure](https://singhwarrior.github.io/Event-Based-Application-Implementing-Back-Pressure/)
1. [The Anna Key-Value Store Now Has 355x the Performance of DynamoDB for the Dollar](http://highscalability.com/blog/2018/9/8/the-anna-key-value-store-now-has-355x-the-performance-of-dyn.html)
...
1. [Kotlin - Structured concurrency](https://medium.com/@elizarov/structured-concurrency-722d765aa952)
1. [Spoofing DNS with fragments](https://blog.powerdns.com/2018/09/10/spoofing-dns-with-fragments/)
