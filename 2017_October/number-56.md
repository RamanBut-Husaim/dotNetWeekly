...
1. [Dissecting the local functions in C# 7](https://blogs.msdn.microsoft.com/seteplia/2017/10/03/dissecting-the-local-functions-in-c-7/)
1. [Contributing to the F# Compiler Service](https://medium.com/real-world-fsharp/contributing-to-the-f-compiler-service-b950264bc84d)
...
1. [How the RyuJIT source code is shared across DotNET Core and DotNET Framework](https://github.com/dotnet/coreclr/issues/14250#issuecomment-333238946)
1. [Roslyn Primer – Part I - Anatomy of a Compiler](https://blogs.msdn.microsoft.com/vbteam/2017/10/02/roslyn-primer-part-i-anatomy-of-a-compiler/)
1. [Proposal for high-performance codegen-less Reflection factory APIs](https://github.com/dotnet/corefx/issues/24390)
1. [Allow entire Types to have their implementation replaced](https://github.com/dotnet/coreclr/issues/14297)
