# .NET Weekly #70 (12.02 - 28.02)

## Cloud & Web

1. [Cloud TPU machine learning accelerators now available in beta](https://cloudplatform.googleblog.com/2018/02/Cloud-TPU-machine-learning-accelerators-now-available-in-beta.html)
1. [Adding HTTP Headers to improve Security in an ASP.NET MVC Core application](https://damienbod.com/2018/02/08/adding-http-headers-to-improve-security-in-an-asp-net-mvc-core-application/)
...
1. [Math.NET Numerics 4.0](https://discuss.mathdotnet.com/t/release-math-net-numerics-4-0/601)
...
1. [Using Google Artificial Intelligence Services in Couchbase N1QL](https://blog.couchbase.com/google-artificial-intelligence-machine-learning-api-couchbase-n1ql/)
1. [NoSQL Performance Benchmark 2018 – MongoDB, PostgreSQL, OrientDB, Neo4j and ArangoDB](https://www.arangodb.com/2018/02/nosql-performance-benchmark-2018-mongodb-postgresql-orientdb-neo4j-arangodb)
1. [Terraforming Stack Overflow Enterprise in AWS](https://medium.com/@palantir/terraforming-stack-overflow-enterprise-in-aws-47ee431e6be7)
1. [Containers - What Are They Good For? Local Dependencies](https://jimmybogard.com/containers-what-are-they-good-for-local-dependencies/)
...
1. [Zombie Processes are Eating your Memory](https://randomascii.wordpress.com/2018/02/11/zombie-processes-are-eating-your-memory/)
1. [Spectre mitigations in MSVC](https://blogs.msdn.microsoft.com/vcblog/2018/01/15/spectre-mitigations-in-msvc)
1. [Announcing Rust 1.24](https://blog.rust-lang.org/2018/02/15/Rust-1.24.html)
