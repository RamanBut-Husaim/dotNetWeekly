...
1. [Role Based Authorization in ASP.NET Core with Azure AD Groups](https://odetocode.com/blogs/scott/archive/2018/02/20/role-based-authorization-in-asp-net-core-with-azure-ad.aspx)
...
1. [Debugging third-party code with Rider – now in Mono!](https://blog.jetbrains.com/dotnet/2018/02/19/debugging-third-party-code-with-rider-now-in-mono/)
1. [Things you need to know about working with SVG in VS Code](https://medium.freecodecamp.org/things-you-need-to-know-about-working-with-svg-in-vs-code-63be593444dd)
1. [Upgrading Mono's Windows.Forms stack on MacOS](http://tirania.org/blog/archive/2018/Feb-20-1.html)
...
1. [Named locks (using Monitor) in .NET - Implementation](https://www.tabsoverspaces.com/233703-named-locks-using-monitor-in-net-implementation)
1. [Analyzing distribution of Mono GC collections](http://aakinshin.net/blog/post/mono-gc-collects/)
