...
1. [Getting Started with Windows Containers](https://blogs.msdn.microsoft.com/webdev/2017/09/07/getting-started-with-windows-containers/)
1. [Creating a rolling file logging provider for ASP.NET Core 2.0](https://andrewlock.net/creating-a-rolling-file-logging-provider-for-asp-net-core-2-0/)
1. [Capture and forward correlation IDs through different Lambda event sources](http://theburningmonk.com/2017/09/capture-and-forward-correlation-ids-through-different-lambda-event-sources/)
1. [IIS Dynamic Compression and new Dynamic Compression features in IIS 10](https://blogs.msdn.microsoft.com/friis/2017/09/05/iis-dynamic-compression-and-new-dynamic-compression-features-in-iis-10/)
1. [Debugging ASP.NET Core 2.0 Source Code](https://www.stevejgordon.co.uk/debugging-asp-net-core-2-source)
1. [3 Reasons Why Astronomer is Betting on GraphQL](https://www.astronomer.io/blog/3-reasons-why-astronomer-is-betting-on-graphql)
...
1. [HashiCorp Vagrant 2.0](https://www.hashicorp.com/blog/hashicorp-vagrant-2-0/)
...
1. [TypeScript - JavaScript + Types = Awesome Developer Productivity - Type Annotations](https://www.barbarianmeetscoding.com/blog/2017/09/07/typescript-javascript-plus-types-equals-awesome-developer-productivity-type-annotations/)
1. [The Incredible Growth of Python](https://stackoverflow.blog/2017/09/06/incredible-growth-python/)

## Runtime

1. [.NET Standard - Demystifying .NET Core and .NET Standard](https://msdn.microsoft.com/en-us/magazine/mt842506)
...
1. [First use of type-safe stack-allocated buffers in C#](https://github.com/dotnet/corefxlab/pull/1742)
1. [.NET Core DLL Hell Is Here. Can .NET Core 2.0 Save Us?](https://stackify.com/net-core-dll-hell/)
...
1. [One Hundred Books in April from Hacker News](http://toptalkedbooks.com/hackernews/201708)
1. [LLVM 5.0.0 Release](http://lists.llvm.org/pipermail/llvm-announce/2017-September/000075.html)