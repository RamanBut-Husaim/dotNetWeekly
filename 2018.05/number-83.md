...
1. [Deploy .NET Machine Learning Models with ML.NET, ASP.NET Core, Docker and Azure Container Instances](http://luisquintanilla.me/2018/05/11/deploy-netml-docker-aci/)
...
1. [Debugging Modern Web Applications](https://hacks.mozilla.org/2018/05/debugging-modern-web-applications/)
...
1. [PostgreSQL 10.4, 9.6.9, 9.5.13, 9.4.18, and 9.3.23 released](https://www.postgresql.org/about/news/1851/)
1. [Kubernetes Chaos Engineering - Lessons Learned](https://learnk8s.io/blog/kubernetes-chaos-engineering-lessons-learned)
1. [Optimistic, scalable ACID transactions](https://medium.com/@andrasgerlits/optimistic-acid-transactions-4f193844bb5f)
1. [ThoughtWorks Tech Radar 2018](https://www.thoughtworks.com/radar)
1. [Microservices First](https://www.conjur.org/blog/2018/05/16/microservices-first.html)
1. [How to store time-series data in MongoDB, and why that’s a bad idea](https://blog.timescale.com/how-to-store-time-series-data-mongodb-vs-timescaledb-postgresql-a73939734016)
1. [High Scalability, High Availability, High Stability, High Performance, and High Intelligence Back-End Design Patterns](https://github.com/binhnguyennus/awesome-scalability)
...
1. [An O(N) Sorting Algorithm - Machine Learning Sorting](https://arxiv.org/abs/1805.04272)
1. [ReasonML vs TypeScript – First impressions](https://lorefnon.tech/2018/05/13/reasonml-vs-typescript-first-impressions/)
1. [Announcing the F# Community Forums](http://foundation.fsharp.org/announcing_the_community_forums)
...
1. [Task, Async Await, ValueTask, IValueTaskSource and how to keep your sanity in modern .NET world](https://blog.scooletz.com/2018/05/14/task-async-await-valuetask-ivaluetasksource-and-how-to-keep-your-sanity-in-modern-net-world/)
1. [.NET Framework May 2018 Preview of Quality Rollup](https://blogs.msdn.microsoft.com/dotnet/2018/05/15/net-framework-may-2018-preview-of-quality-rollup/)
1. [Support mixed-mode assemblies](https://github.com/dotnet/coreclr/issues/18013)
1. [Custom memory allocation in C# Part 1 — Allocating object on a stack](https://blog.adamfurmanek.pl/2016/04/23/custom-memory-allocation-in-c-part-1/)
1. [How you would add a new, fundamental type to the CoreCLR](https://github.com/dotnet/coreclr/pull/17872/files)
...
1. [After 5 years and $3M, here's everything we've learned from building Ghost](https://blog.ghost.org/5/)
